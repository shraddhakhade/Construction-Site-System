...
{
    public partial class Orderbysearching : Form
    {
        public Orderbysearching()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                conn.cn.Close();
                conn.cn.Open();
                conn.da = new SqlDataAdapter("Select distinct * from purchaseview where poid="+textBox1.Text +"", conn.cn);
